  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Streamlining Your Human Resources Operations for Optimal Efficiency and Unmatched Productivity"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Streamlining Your Human Resources Operations for Optimal Efficiency and Unmatched Productivity`}
            </Text>
            <Box
